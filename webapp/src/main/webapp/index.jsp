...
@-webkit-keyframes a_smoke{
  0%{ -webkit-transform:scale(0.5) translate(0,0); opacity:0;}
  25%{ -webkit-transform:translate(-6px,0px); opacity:1;}
  50%{ -webkit-transform:translate(-12px,-4px); opacity:1;}
  75%{ -webkit-transform:translate(-18px,-12px);opacity:0.5;}
  100%{ -webkit-transform:scale(1) translate(-22px,-16px); opacity:0;}
}
